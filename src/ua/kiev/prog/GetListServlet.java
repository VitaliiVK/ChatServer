...
public class GetListServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
		...
		String loginStr = req.getParameter("login"); //получаем логин пользователя
		...
		String json = msgList.toJSON(from, loginStr, tooStr, priv); //получаем строку в формате JSON в которой записан список сообщений
